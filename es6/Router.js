...
var Router = React.createClass({
  ...
  createRouterObjects: function createRouterObjects() {
    ...
    !!isUnsupportedHistory(history) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'You have provided a history object created with history v>=3 ' + 'This version of React Router is not compatible with v>=3 history ' + 'objects. Please use history v2.x instead.') : invariant(false) : void 0;
